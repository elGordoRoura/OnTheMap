//
//  EGListHeaderFooterController.swift
//  OnTheMap
//
...
open class EGListHeaderFooterController<T: EGListCell<U>, U, H: UICollectionReusableView, F: UICollectionReusableView>: UICollectionViewController {
    ...
    required public init?(coder aDecoder: NSCoder) {
        fatalError("You most likely have a Storyboard controller that uses this class, please remove any instance of EGListHeaderController or sublasses of this component from your Storyboard files.")
    }
}
