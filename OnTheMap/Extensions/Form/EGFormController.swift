...
#if os(iOS)
@available(iOS 11.0, *)
open class EGFormController: UIViewController {
    ...
    public required init?(coder aDecoder: NSCoder) {
        fatalError("You most likely have a Storyboard controller that uses this class, please remove any instance of EGFormController or sublasses of this component from your Storyboard files.")
    }
}
#endif
